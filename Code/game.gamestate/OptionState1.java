...
public class OptionState1 extends GameState{
    private final String ques="Do you like cities or forest";
     private final String[] options = {"Cities","Forest"};
    ...
    public void draw(Graphics g) {
        ...
        if(0 == currentSelection){
            g2.drawImage(Images.blocks[8],0, 0, 900, 600, null);
        } else {
            g2.drawImage(Images.blocks[9],0, 0, 900, 600, null);
        }
    ...
    public void keyPressed(int k) {
        ...
        if(k == KeyEvent.VK_ENTER){
            switch (currentSelection) {
                case 0:
                    gsm.states.push(new CityState(gsm));
                    break;
                case 1:
                     gsm.states.push(new ForestState(gsm));
                    break;
                default:
                    break;
            }
